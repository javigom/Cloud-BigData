...
# Elimino aquellos que no sean actores/actrices
DFtp = DFtp.filter((DFtp["category"] == "actress") | (DFtp["category"] == "actor"))
...
# Calculo la suma de las valoraciones de las peliculas en las que participa un actor
...
# Guardo el resultado como un DF, sustituyendo el identificador del actor por su nombre y ordenando en orden decreciente por la valoracion
